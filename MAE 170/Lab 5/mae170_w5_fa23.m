...
s_speaker = serialport('COM4',115200); % Serialport connection
...
oscObj = visadev('USB0::0x1AB1::0x0588::DS1ET213707739::INSTR');

% [EDIT THE FOLLOWING PARAMETERS BASED ON THE LAB PROCEDURE]
verticalscale1 = .50; % channel 1 vertical scale [V]
verticalscale2 = .20; % channel 2 vertical scale [V]
