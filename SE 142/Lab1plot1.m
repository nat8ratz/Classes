...
figure(2)
hold on;
p = polyfit(extensometer(1:164),stress(1:164),1)
y = polyval(p,extensometer(1:164));
eq = sprintf('y = %.2ex + %.2e', p);
plot(extensometer(1:226),stress(1:226),LineWidth=2)
plot(extensometer(1:164),y,LineWidth=2)
xlabel('Strain');
ylabel('Stress (psi)');
